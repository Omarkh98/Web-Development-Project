...
<script>
    function showHint(str) {
      ...
      <title> The Society Mirror - Advertise </title>
  </head>
  <?php
  ...
  <body> 
   ...
   color: red;
    ...
    text-decoration: underline;
             ...
             <div class="AdvertiseBody">
             <h1> Advertise With Us!</h1>
            <div id="Image">
             <h2>Latest E-Edition</h2>
             <img src="E-Edition.png" width="200" height="220">
             </div>
             <h2> Benefits of Advertising With Us :</h2>
             <h3>Credibility:</h3>
             <p>We have built this business by building long-lasting relationships with local businesses in the High Country. We are a news source that the community trusts. When you advertise in our newspapers, magazines, and websites, we are extending a piece of our credibility on to you.</p>
            <h3>Experience & Knowledge:</h3>
            <p>We know the market and how to reach your potential customer. Over time we have learned what forms of advertising and techniques work in this market. Utilize our experience and knowledge for your gain. Contact us and we will develop an advertising plan that suit your needs.</p>
            <h3>Teamwork:</h3>
            <p>Our team is on your team. For every success, there is a team involved. We have a fantastic team of professionals ready to help you launch your successful marketing campaign. Utilize each of our team member's skills in your favor. Contact us and we will team up with you on your next marketing campaign.</p>
            <h4>Meet Our Team :</h4>
            <ul>
            <li><b>Editor</b><br>
            Nouran Khaled - (Nouran1997@hotmail.com)</li><br>
            <li><b>Publisher</b><br>
            Omar Khaled - (omar1998@live.com)</li><br>
            <li><b>Sports</b><br>
            Hashem Mohamed - (HashemMoh@yahoo.com)</li><br>
            </ul>
             <div id="News">
            <h2>Latest News</h2>
            <ul>
            <li>The Latest: Schumer to Trump: 'No excuse' for hurting people.</li><br>
            <li>43,000 customers to get refund in latest overcharging blunder to hit banking sector.</li><br>
            <li>We might be confused by Brexit, but the rest of the world is utterly baffled.</li><br>
            <li>Anothony Joshua Still undefeated world champion.</li><br>
            <li>Beast from the East could return with heavy snow and freezing temperatures.</li><br>
            <li>Lewis Hamilton wins the world series...AGAIN.</li><br>
            </ul>
           </div>
           </div>
 <style type="text/css">
