...
<script>
    function showHint(str) {
      ...
      <title> The Society Mirror - Subscribe </title>
  </head>
  <?php
  ...
  <body> 
   ...
   color: red;
    ...
    text-decoration: underline;
             ...
             <h2> SIGN UP today to the Society Mirror and follow all our news !</h2>
             <h3>What You'll be getting :</h3>
            <ul>
            <li><b>Sports</b><br>
            Daily Sports News and Live Market Transfers.</li><br>
            <li><b>Medical</b><br>
            Daily Medical Achievments and Inventions.</li><br>
            <li><b>Economy</b><br>
            Daily news on the stock market.</li><br>
            <li><b>Weather</b><br>
            Weather Forcast everyday for all countries.</li><br>
            <li><b>Politics</b><br>
            Latest and Breaking political occurences.</li><br>
            </ul>
            <div id="News">
            <h2>Latest News</h2>
            <ul>
