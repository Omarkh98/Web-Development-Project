...
<script>
    function showHint(str) {
      ...
      <title> The Society Mirror - Contact Us </title>
  </head>
  <?php
...
#News li:hover {
   color: red;
    text-decoration: underline;
             ...
             <h1> Contact Us</h1>
             <h2> The Society Mirror Newspaper</h2>
             <p>Street 90, Tagamo El Khamis</p>
             <p><b>Phone</b>: 01205566809 </p>
             <p><b>Fax</b>: 828-262-0282 </p><br>
             <div id="Image">
             ...
             <h3>Crew:</h3>
             <ul>
             <li><b>Nouran Khaled</b>- Editor (Nouran1997@hotmail.com)</li><br>
             <li><b>Omar Khaled</b>- Publisher (omar1998@live.com)</li><br>
             <li><b>Hashem Mohamed</b>- Sports (HashemMoh@yahoo.com)</li><br>
             </ul>
            <div id="News">
            <h2>Latest News</h2>
            <ul>
            <li>Two charged with animal cruelty, starvation in Ashe.</li><br>
            <li>Roger Federer back to retain his Australian open title.</li><br>
            <li>Leading member of Parliament 'yellow vest' group says MP Anna Soubry deserved to be heckled.</li><br>
            <li>Three months of STORMS to hit UK - latest long range forecast.</li><br>
            <li>Rockets hold off Green Valley to win 42-38.</li><br>
            <li>South Carolina Senate approves new rules.</li><br>
            </ul>
           </div>
           </div> 
             </div>
